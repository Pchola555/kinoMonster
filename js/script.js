const slides = document.querySelectorAll('.hero-block>li');
const dots = document.querySelectorAll(".next-main-slider-dots>span");
const interval = 3; //переменная для измененнния времени смены слайдов//
...
const submenu = document.querySelector('.second-nav-mobile');
let is_open = 0;
